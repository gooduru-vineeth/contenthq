  ...
  return (
    <div className="relative mx-auto w-full max-w-lg">
      ...
      >
        ...
        <div className="flex items-center justify-between border-t border-white/5 pt-4">
          ...
          <div className="flex items-center gap-1.5 text-xs text-cta-400">
            <span className="inline-block h-1.5 w-1.5 animate-pulse rounded-full bg-cta-400" />
            ETA: 2 min
          </div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute -right-4 -top-4 rounded-xl border border-white/10 bg-slate-900/90 px-3 py-2 shadow-lg backdrop-blur-sm sm:-right-12"
      >
        <div className="flex items-center gap-2">
